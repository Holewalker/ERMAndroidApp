...
public class EmgServiceEditPresenter implements EmgServiceEditContract.Presenter, EmgServiceEditContract.Model.OnEditEmgServiceListener {
    private EmgServiceEditModel model;
    private EmgServiceAddView view;

    public EmgServiceEditPresenter(EmgServiceAddView view) {
